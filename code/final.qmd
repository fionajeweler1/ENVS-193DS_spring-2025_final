...
model_table <- tibble::tibble(
  ...
  `Distance to forest edge included` = c("No", "Yes", "No", "Yes"),
  `Model description` = c(
    "Null model (no predictors)",
    "Saturated model (interaction between season and edge_distance)",
    "Main effect of season only",
    "Main effect of edge_distance only"
  )
)
